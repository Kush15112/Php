...
<!doctype html>
      ...
      <a class="navbar-brand" href="/Task 8/regForm.php">InternTech</a>
      ...
      <div class="collapse navbar-collapse" id="navbarSupportedContent">
          ...
          <li class="nav-item">
              <a class="nav-link" href="/Task 8/regForm.php">Registration</a>
          </li>
          <li class="nav-item">
              <a class="nav-link" href="/Task 8/stdTable.php">Display Data</a>
          </li>
          </ul>
...
echo"</table>";
echo"<a href = '/Task 8/regForm.php'>Add Records</a>";
?>