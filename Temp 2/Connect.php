      ...
      <div id="getintouch" class="section wb wow fadeIn" style="padding-bottom:0;">
         ...
         <div class="contact-section">
            <div class="form-contant">
               <form id="ajax-contact" action="Clients.php" method="post">
                  <div class="row">
                     <div class="col-md-6">
                     ...
                     <div class="col-md-6">
                        <div class="form-group in_email">
                           <input type="text" class="form-control" id="subject" name="sub" placeholder="Subject" required="required">
                        </div>
                     </div>
                     <div class="col-md-12">
                        <div class="form-group in_message"> 
                           <textarea class="form-control" id="message" rows="5" name="desc" placeholder="Message" required="required"></textarea>
                        </div>
                        <div class="actions">
